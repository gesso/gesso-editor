...
class Groups extends React.Component<{}, IState> {
        ...
        <div style={groupStyle}>
          <Container
            ...
            {this.state.itemsLeft.map(blockValue => {
              return <Block key={blockValue.id} blockValue={blockValue} onTarget={this.onTarget} onUntarget={this.onUntarget} />;
            })}
          </Container>
        </div>
        <div style={groupStyle}>
    ...
    return dropResult => {
      ...
      if (this.state.targetBlock) {
        ...
        const updatedState: IState = {
          ...this.state,
          [blockListKey]: utils.applyCompose(blocks, dropResult, blockListKey, this.state.targetBlock)
        };
